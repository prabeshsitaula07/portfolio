...
export default function Techstack() {
  return (
    ...
    <h2 align="center"  style={{ textAlign: "center", fontSize: "40px !important", fontWeight: "bold"}}><span>Tech Stack</span></h2>
    <div className="tech-logo">
        ...
        <div className="icon-logo"><img src="iconlogo/html.png" alt="" /></div>
        <div className="icon-logo"><img src="iconlogo/css-3.png" alt="" /></div>
        <div className="icon-logo"><img src="iconlogo/js.png" alt="" /></div>
        <div className="icon-logo"><img src="iconlogo/jquery.png" alt="" /></div>
        <div className="icon-logo"><img src="iconlogo/c.png" alt="" /></div>
        ...
        <div className="icon-logo"><img src="iconlogo/docker.png" alt="" /></div>
        <div className="icon-logo"><img src="iconlogo/nodejs.png" alt="" /></div>
    </div>
    </section>
    </>
  )
